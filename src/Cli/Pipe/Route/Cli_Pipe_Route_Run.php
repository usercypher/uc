    ...
    function call($input, $output) {
        ...
        if (isset($result['error'])) {
            ...
            if ($result['error'] === 405) {
                ...
                $this->app->env['handle_error_context'] = array(
            ...
            list($_, $output) = $this->app->pipe($tempInput, $output, array_merge($this->app->env['route_handler_prepend'], $result['handler'], $this->app->env['route_handler_append']));
        }
